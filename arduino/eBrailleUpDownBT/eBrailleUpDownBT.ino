...
// eBraille Dots Data Pins
const byte brailleDot[6] = {
  36, 38, 40, 42, 44, 46
};

// eBraille Cell Enable Pins
const byte cellEnable[10] = {
  23, 25, 27, 29, 31, 33, 35, 37, 39, 41
};

// eBraille Buttons Pins
#define nextLinePin 48 // B0
#define prevLinePin 50 // B1
...
void getSerialData() {
  while (btSerial.available()) {
    ...
    char inChar = (char)btSerial.read();
      ...
      line = 0;
      charIndex = 0;
      charIndexAtLineStart[line] = 0;
      inputString = "";
      Serial.println("String: \"" + textEng + "\" received from Bluetooth!!!");
      btSerial.println("String: \"" + textEng + "\" received!!!");
      printEBraille();
    }
    else {
      inputString += inChar;
